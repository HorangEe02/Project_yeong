...
_APQP_UPDATES = [
    {
        ...
        "reference_url": "https://go.aiag.org/apqp-cp",
    },
    {
    ...
    },
    {
        ...
        "reference_url": "https://www.aiag.org/expertise-areas/quality/quality-core-tools",
    },
]
...
class APQPCrawler:
    ...
    def crawl(self) -> APQPCrawlResult:
        ...
        for item in _APQP_PHASES:
            try:
                ...
                normalized.setdefault("reference_url", "https://go.aiag.org/apqp-cp")
                phases.append(APQPPhase(**normalized))
        ...
        for item in _APQP_CHECKLIST:
            try:
                normalized = dict(item)
                normalized.setdefault("reference_url", "https://go.aiag.org/apqp-cp")
                checklists.append(APQPChecklist(**normalized))
            except Exception as e:
        ...
        result.source_reason = (  # type: ignore[attr-defined]
            "APQP process baseline is curated from official AIAG/OEM/VDA sources; "
    ...
    def _save(self, result: APQPCrawlResult):
        ...
        data = {
            ...
            "data": [asdict(p) for p in result.phases],
