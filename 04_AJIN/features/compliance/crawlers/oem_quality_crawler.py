...
_DEFAULT_REFERENCE_URLS = {
    "BIQS": "https://www.gm.com/supply-chain-responsibility",
    "CQI": "https://www.aiag.org/expertise-areas/quality/quality-core-tools",
    "Formel-Q": "https://www.vwgroupsupply.com/",
    "SQ": "https://suppliers.hyundai.com/",
}
...
class OEMQualityCrawler:
    ...
    def crawl(self) -> OEMQualityCrawlResult:
        ...
        for item in _MASTER_DATA:
            try:
                ...
                normalized.setdefault(
                    "reference_url",
                    _DEFAULT_REFERENCE_URLS.get(str(normalized.get("category")), ""),
                )
                std = OEMQualityStandard(**normalized, crawled_at=now)
        ...
        result.source_type = "curated"  # type: ignore[attr-defined]
        result.source_reason = (  # type: ignore[attr-defined]
            "OEM quality baseline is curated from official supplier and industry-standard sources; "
            "live official source reachability is checked by the release verifier."
        )
        result.http_meta = {}  # type: ignore[attr-defined]
    ...
    def _save(self, result: OEMQualityCrawlResult) -> None:
        ...
        data = {
            ...
            "source": f"{result.source} (curated baseline)",
            ...
            "data": [asdict(s) for s in result.standards],
