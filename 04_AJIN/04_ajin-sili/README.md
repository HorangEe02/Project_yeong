...
- 사내 private repo (HorangEe02/ajin-ai-assistant-react)
- 기여: 사내 개발팀 + Claude Code (AI assistant)
- 외부 공개 미예정
...
- **운영 이슈** — `make logs` + `make ps` 결과 첨부
- **코드 이슈** — GitHub repo Issues (private)
- **도메인 문의** — 안전보건팀·품질보증팀·기술교육원·총무인사팀 (각 Feature 핵심 사용자 부서)
